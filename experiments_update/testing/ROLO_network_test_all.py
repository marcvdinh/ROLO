...
class ROLO_TF:
    ...
    istate = tf.placeholder(tf.float32, [None, 2 * num_input])  # state & cell => 2x num_input
    ...
    def LSTM_single(self, name, _X, _istate, _weights, _biases):
        ...
        #cell = tf.nn.rnn_cell.LSTMCell(self.num_input, self.num_input)  1.0
    ...
    def testing(self, x_path, y_path):
        ...
        with tf.Session() as sess:
            ...
            print
            "Time Spent on Tracking: " + str(total_time)
            print
            "fps: " + str(id / total_time)
